...
const Navbar = () => {
  ...
  return (
    <header
      className={`fixed z-[9999] w-full px-10 lg:px-16 py-3 lg:py-5 font-montreal text-gray-200 transition-all duration-500 transform ${
        scrolled
          ? "bg-white/5 backdrop-blur-md border-b border-white/10 shadow-md"
    ...
    >
          ...
          {["Services", "Our Work", "About Us", "Insights", "Contact"].map(
            (item, index) => (
              <a
                key={index}
                href="#"
                className={`inline-block text-lg 2xl:text-[1vw] capitalize font-regular font-montreal group relative after:content-[''] after:absolute after:left-0 after:right-0 after:h-[0.05em] after:bg-gray-100 after:bottom-[-0.15em] after:origin-[100%_100%] after:scale-x-0 after:pointer-events-none after:transition-transform hover:after:ease-[cubic-bezier(.215,.61,.355,1)] hover:after:duration-[.5s] hover:after:origin-[0_0] hover:after:scale-x-100 ${
                  index === 4 && "ml-32"
                }`}
              >
                <span className="block relative overflow-hidden">
                  <span className="block relative transition-transform ease-[cubic-bezier(.215,.61,.355,1)] duration-[.5s] group-hover:-translate-y-full">
                    {item}
                  </span>
                  <span className="block transition-transform ease-[cubic-bezier(.215,.61,.355,1)] duration-[.5s] absolute left-0 top-0 translate-y-full group-hover:translate-y-0">
                    {item}
                  </span>
                </span>
              </a>
      ...
      <div
        className={`lg:hidden fixed inset-0 w-full h-screen  bg-zinc-900 text-white transition-transform duration-700 ease-[cubic-bezier(.4,0,.2,1)] shadow-lg z-50 overflow-y-auto   ${
      ...
      >
        ...
        <div className="flex flex-col items-start px-10 py-8 gap-8">
          {["Services", "Our Work", "About Us", "Insights", "Contact"].map(
            (item, i) => (
              <a
                key={i}
                href="#"
                onClick={() => setOpen(false)}
                className="text-6xl font-bold uppercase hover:text-sky-100 transition relative after:content-[''] after:absolute after:left-0 after:right-0 after:h-[0.05em] after:bg-gray-100 after:bottom-[-0.15em] after:origin-[100%_100%] after:scale-x-0 after:pointer-events-none after:transition-transform ease-[cubic-bezier(.215,.61,.355,1)] duration-[.5s] hover:after:origin-[0_0] hover:after:scale-x-100"
              >
                {item}
              </a>
            )
